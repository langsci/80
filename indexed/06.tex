...
\citegen{Pustejovsky1991} representation of a \isi{Transition} Event Structure may be modified to reflect this analysis of items in this class from the perspective of their \isi{categorial status}: 

\ea%4
\label{ex:6:4}

\isi{Transition} Event Structure as reflecting a Change of state\is{State!Change of} verb 
\begin{center}\fbox{\parbox{5cm}{\centering 
\begin{forest}
...
In spite of the variation observed in the behaviour of these items, I have argued that these all share a common Event Structure of \isi{State} shown in \REF{ex:6:10}, (\ref{ex:5:18} recalled from \chapref{sec:5}): 
